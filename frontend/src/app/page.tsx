...
import { Folder, Terminal, Code2, FileText, Plus, RefreshCw, Trash2, Command } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div key={project.id} className="bg-slate-900 border border-slate-800 rounded-xl p-6 hover:border-slate-700 transition-all group shadow-sm">
              ...
              <div className="grid grid-cols-4 gap-2">
                <button 
                  onClick={() => launch(project.path, 'vscode')}
